  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-cream-dark rounded-sm",
        ghost: "hover:bg-secondary hover:text-secondary-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "border-2 border-cream bg-transparent text-cream hover:bg-cream hover:text-espresso uppercase tracking-widest rounded-sm",
        accent: "bg-accent text-accent-foreground hover:bg-teal-dark rounded-sm",
        gold: "bg-gold text-espresso hover:bg-gold-light font-semibold uppercase tracking-widest rounded-sm",
      },
      size: {
